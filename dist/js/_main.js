$('a.navbar-brand').click(function(){
   ...
   setTimeout(function(){ $('.homeSlide').html(
       "<div class=\"bcg\"" +
		...
		"<div class=\"jumbotron\">" +
			"<img id=\"logo_page\" src=\"assets/img/logo.jpg\"/>" +
   ...
   setTimeout(function(){ $('.homeSlide').html(
       "<div class=\"bcg\""+
		...
		"<div class=\"jumbotron\">" +
            ...
            "<img class=\"work\" src=\"assets/img/folder_closed2.png\"/>" +
            "<br>" +
            "<img class=\"work2\" src=\"assets/img/folder_open.png\"/>" +
            "<br>" +
...
$('a.aboutPage').click(function(){
   ...
   setTimeout(function(){ $('.homeSlide').html(
       "<div class=\"bcg\"" +
		...
		"<div class=\"jumbotron\">" +
			"<h1>About</h1>" +
			"<p class=\"lead\">Jaylor Construction</p>" +
